...
public class GetTemplatesAll extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7372914293167236665L;

	/**
	 * Constructor of the object.
	 */
	public GetTemplatesAll() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for(Template template: mrtemplates)
		{
			...
			sb.append("\r        <id>"+template.getId()+"</id>");
			sb.append("\r		 <name>"+template.getName()+"</name>");
